...
class AndroidPlatformServices(private val context: Context) : PlatformServices {
    ...
    private val powerupSound: Int = soundPool.load(context, R.raw.powerup, 1)
    ...
    override fun playWhooshSound() {
        // Play pre-loaded swoosh sound from SoundPool (louder volume)
        soundPool.play(swooshSound, 1.5f, 1.5f, 1, 0, 1f)
    }
